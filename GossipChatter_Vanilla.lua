...
GossipTracker.button = CreateFrame("Button", nil, QuestFrame)
GossipTracker.button:SetPoint("CENTER", QuestFrame, "TOPRIGHT", -65, -30)
...
GossipTracker.button2 = CreateFrame("Button", nil, GossipFrame)
GossipTracker.button2:SetPoint("CENTER", GossipFrame, "TOPRIGHT", -65, -30)
...
GossipTracker.button3 = CreateFrame("Button", nil, ItemTextFrame)
GossipTracker.button3:SetPoint("CENTER", ItemTextFrame, "TOPRIGHT", -65, -25)
...
function GossipTracker:OnEvent(event,arg1)
	...
	if event == "GOSSIP_SHOW"  then
		...
		body = CHAT_SAY_GET:format(sender) .. GossipGreetingText:GetText()
